...
export declare class RelatoriodiarioController {
    private readonly relatoriodiarioService;
    constructor(relatoriodiarioService: RelatoriodiarioService);
    findUnprocessed(): Promise<({
        autoinfracao: {
            id: number;
